...
### Model View Controller and File structure
...
Create folder name "controller", Next, Create file name "product.js" in controller folder
...
const server = express();
const productController = require("./controller/product");
const productRouter = express.Router(); //Notice this
...
server.use(morgan("default"));
server.use(express.static("public"));
server.use("/api/v1", productRouter); //Notice this
...
Create folder name "routes", Next, Create file name "product.js" to the folder.

<details><summary>product.js : In routes folder</summary>
...
server.use(morgan("default"));
server.use(express.static("public"));
server.use("/api/v1", productRouter.router); //Notice this
...
server.use(morgan("default"));
server.use(express.static("public"));
server.use("/products", productRouter.router); //Notice this
...
Create file name user.js in controller folder.

<details><summary>user.js : In controller folder</summary>

```
const fs = require("fs");
// const index = fs.readFileSync("./02_/index.html", "utf-8");
const data = JSON.parse(fs.readFileSync("./05_/data.json", "utf-8"));
...
Create file name user.json in routes folder.

<details><summary>user.js : In routes folder</summary>
...
const server = express();
const productRouter = require("./routes/product");
const userRouter = require("./routes/user"); //Notice this
...
server.use("/user", userRouter.router); //Notice this
